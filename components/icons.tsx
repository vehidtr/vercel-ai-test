...
export const StarIcon = ({ size }: { size?: number }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M1.02 0.503a0.067 0.067 0 0 0 -0.039 -0.12l-0.27 -0.01a0.007 0.007 0 0 1 -0.006 -0.004l-0.093 -0.252a0.067 0.067 0 0 0 -0.125 0l-0.093 0.253a0.007 0.007 0 0 1 -0.006 0.004l-0.27 0.01a0.067 0.067 0 0 0 -0.039 0.12l0.212 0.166a0.007 0.007 0 0 1 0.002 0.007l-0.073 0.258a0.067 0.067 0 0 0 0.101 0.073l0.224 -0.15a0.007 0.007 0 0 1 0.007 0l0.224 0.15a0.066 0.066 0 0 0 0.076 0 0.066 0.066 0 0 0 0.025 -0.072l-0.073 -0.259a0.007 0.007 0 0 1 0.002 -0.007Z"
      />
      <path
        x="0"
        y="0"
...
export const StarOutlinedIcon = ({ size }: { size?: number }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        fill="currentColor"
        d="M0.816 1.02a0.066 0.066 0 0 1 -0.037 -0.011l-0.224 -0.15a0.007 0.007 0 0 0 -0.007 0l-0.224 0.15a0.067 0.067 0 0 1 -0.101 -0.072l0.073 -0.259a0.007 0.007 0 0 0 -0.002 -0.007l-0.212 -0.166a0.067 0.067 0 0 1 0.039 -0.12l0.27 -0.01a0.007 0.007 0 0 0 0.006 -0.004l0.093 -0.253a0.067 0.067 0 0 1 0.125 0l0.093 0.253a0.007 0.007 0 0 0 0.006 0.004l0.27 0.01a0.067 0.067 0 0 1 0.039 0.12L0.81 0.67a0.007 0.007 0 0 0 -0.002 0.007l0.073 0.259A0.067 0.067 0 0 1 0.816 1.02m-0.265 -0.223a0.066 0.066 0 0 1 0.037 0.013l0.224 0.15a0.007 0.007 0 0 0 0.01 -0.007l-0.073 -0.259a0.066 0.066 0 0 1 0.023 -0.07l0.212 -0.166a0.007 0.007 0 0 0 -0.004 -0.012l-0.27 -0.01a0.067 0.067 0 0 1 -0.06 -0.044l-0.093 -0.253a0.007 0.007 0 0 0 -0.013 0L0.452 0.39a0.067 0.067 0 0 1 -0.06 0.044l-0.27 0.01a0.007 0.007 0 0 0 -0.004 0.012L0.33 0.623a0.067 0.067 0 0 1 0.023 0.07l-0.073 0.259a0.006 0.006 0 0 0 0.002 0.007 0.006 0.006 0 0 0 0.008 0l0.224 -0.15a0.066 0.066 0 0 1 0.037 -0.011Z"
      />
      <path x="0" y="0" width="36" height="36" d="M0 0H1.08V1.08H0V0z" />
    </svg>
  );
};
